...
class PdfCommonSections {
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    if (senderInfo.phone != null ||
                        senderInfo.email != null) ...[
                      pw.Text(
                        [
                          if (senderInfo.phone != null &&
                              senderInfo.phone!.isNotEmpty)
                            'Teléfono: ${senderInfo.phone}',
                          if (senderInfo.email != null &&
                              senderInfo.email!.isNotEmpty)
        ...
        children: [
          pw.Column(
            ...
            children: [
              ...
              pw.Text('© 2026', style: PdfThemeConfig.captionStyle),
            ],
          ),
          pw.Align(
      ...
      child: pw.Column(
        ...
        children: [
          pw.Container(
            ...
            child: pw.Text(title, style: PdfThemeConfig.cardHeaderStyle),
          ),
          ...children,
        ],
      ),
  ...
  static pw.Widget buildTableHeaderCell(String text, pw.Alignment alignment) {
    return pw.Container(
      alignment: alignment,
      padding: const pw.EdgeInsets.symmetric(horizontal: 8, vertical: 6),
      child: pw.Text(text, style: PdfThemeConfig.tableHeaderStyle),
    );
  }
