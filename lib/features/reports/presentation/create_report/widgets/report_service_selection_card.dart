...
class ReportServiceSelectionCard extends StatefulWidget {
  ...
  const ReportServiceSelectionCard({
    super.key,
  ...
  @override
  State<ReportServiceSelectionCard> createState() =>
      _ReportServiceSelectionCardState();
}

class _ReportServiceSelectionCardState
    extends State<ReportServiceSelectionCard> {
  @override
  Widget build(BuildContext context) {
    ...
    final isInactive = widget.isAlreadyInReport || widget.isLocked;
    final opacity = widget.isAlreadyInReport
        ? 0.5
