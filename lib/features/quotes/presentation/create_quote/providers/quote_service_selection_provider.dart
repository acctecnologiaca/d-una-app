...
// Paginated Provider
final paginatedQuoteServiceSearchProvider = AsyncNotifierProvider<PaginatedQuoteServiceSearch, PaginatedState<ServiceModel>>(
  () => PaginatedQuoteServiceSearch(),
);

class PaginatedQuoteServiceSearch extends AsyncNotifier<PaginatedState<ServiceModel>> {
