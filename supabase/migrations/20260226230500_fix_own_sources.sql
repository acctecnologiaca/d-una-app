-- ==============================================================================
-- FIX: get_product_sources RPC (Own Inventory Aggregation)
-- Description: Fixes a bug in the first half of the UNION ALL query (OWN sources)
-- where the `uoms` table was not being joined, and the fallback values in 
-- COALESCE for model and uom were incorrect, preventing own inventory from matching
-- the requested product grouping.
-- ==============================================================================
