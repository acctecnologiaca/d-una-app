      ...
      return jsonResponse({
        ...
        report: {
          ...
          client: report.clients ? {
            name: report.clients.name || 'Cliente',
            tax_id: report.clients.tax_id || report.clients.identification_id || '-',
            phone: report.contacts?.phone || report.clients.phone || '-',
            email: report.contacts?.email || report.clients.email || '-',
            contact_name: report.contacts?.name || report.clients.contact_name || '-',
            type: report.clients.type || 'person',
            address: report.clients.address || '-',
            city: report.clients.city || '-',
            state: report.clients.state || '-',
            country: report.clients.country || '-',
          } : null,
        ...
        issuer: profile ? {
          ...
          user_name: `${profile.first_name || ''} ${profile.last_name || ''}`.trim() || profile.full_name || 'Especialista Asignado',
          phone: profile.phone || '-',
          email: profile.email || '-',
